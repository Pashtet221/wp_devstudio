<?php
/*
Template Name: Услуга — Перенос интернет-магазина с OpenCart на WordPress
		...
		<div class="gl-service-container">
			<div class="gl-service-hero__grid">
				<div class="gl-service-hero__main">
					<div class="gl-service-pill">Миграция OpenCart → WooCommerce</div>
					<h1 class="gl-service-title"><?php the_title(); ?></h1>

					<p class="gl-service-subtitle">
						Перенос интернет-магазина с OpenCart на WordPress и WooCommerce с сохранением структуры,
				...
				<div class="gl-service-hero__side">
					...
					<p class="gl-service-side__text">
						...
						используемых модулей OpenCart, фильтров, способов оплаты, доставки и нужных доработок.
					</p>

					<ul class="gl-service-side__list">
						<li>Перенос с OpenCart на WordPress и WooCommerce</li>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Перенос магазина с OpenCart на WordPress без потери каталога и структуры</h2>
				<p>
					Перенос с OpenCart — это не просто выгрузка товаров. Важно правильно перенести каталог,
			...
			<div class="gl-service-grid-3">
				<div class="gl-service-card">
					<h3>Аудит OpenCart</h3>
					<p>
						Проверяю текущий магазин на OpenCart: структуру каталога, товары, категории, производителей,
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Когда стоит переносить магазин с OpenCart на WordPress</h2>
			</div>

			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					<ul class="gl-service-list">
						<li>Текущий магазин на OpenCart сложно дорабатывать и развивать</li>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Как проходит перенос магазина с OpenCart на WordPress</h2>
				<p>
		...
		<div class="gl-service-container">
			...
			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					...
					<ul class="gl-service-list">
						<li>Анализ старого магазина на OpenCart</li>
			...
			<div class="gl-service-includes-note">
				<p>
					Если на старом сайте много товаров, сложные фильтры, нестандартные модули OpenCart,
	...
	<section class="gl-service-section" id="service-faq">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Частые вопросы по переносу с OpenCart на WordPress</h2>
			</div>

			<div class="gl-service-faq">
				<div class="gl-service-faq__item">
					<h3>Можно ли перенести товары из OpenCart в WooCommerce?</h3>
					<p>
				...
				<div class="gl-service-faq__item">
					...
					<p>
						...
						Часто перенос с OpenCart на WooCommerce используют как возможность обновить интерфейс,
				...
				<div class="gl-service-faq__item">
					<h3>Сколько стоит перенос магазина с OpenCart?</h3>
					<p>
			...
			<div class="gl-service-cta">
				<div class="gl-service-cta__box">
					<h2>Хотите перенести магазин с OpenCart на WordPress без потери каталога и структуры?</h2>
					<p>
