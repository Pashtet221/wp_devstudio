<?php
/*
Template Name: Услуга — Перенос интернет-магазина с Joomla на WordPress
		...
		<div class="gl-service-container">
			<div class="gl-service-hero__grid">
				<div class="gl-service-hero__main">
					<div class="gl-service-pill">Миграция на WooCommerce</div>
					<h1 class="gl-service-title"><?php the_title(); ?></h1>

					<p class="gl-service-subtitle">
						Перенос интернет-магазина с Joomla на WordPress и WooCommerce с сохранением структуры,
						товаров, категорий, контента и ключевой логики магазина. Помогаю уйти с устаревшей
						или неудобной Joomla-платформы на более гибкую систему, которую проще развивать,
						обновлять и дорабатывать под бизнес.
					</p>

					<ul class="gl-service-points">
						<li>Перенос товаров, категорий, изображений и характеристик</li>
						<li>Воссоздание структуры магазина на WordPress и WooCommerce</li>
						<li>Настройка карточек товаров, корзины и оформления заказа</li>
						<li>Подготовка магазина к дальнейшему SEO и развитию</li>
					</ul>
				...
				<div class="gl-service-hero__side">
					...
					<p class="gl-service-side__price">от 80 000 ₽</p>
					<p class="gl-service-side__text">
						Итоговая цена зависит от объема каталога, текущего состояния сайта на Joomla,
						количества товаров, структуры категорий, модулей, фильтров и нужных доработок.
					</p>

					<ul class="gl-service-side__list">
						<li>Перенос с Joomla, JoomShopping, VirtueMart и других решений</li>
						<li>WordPress + WooCommerce вместо устаревшей или неудобной системы</li>
						<li>Сохранение важного контента, структуры и логики магазина</li>
						<li>Возможность обновить дизайн и улучшить удобство покупки</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Перенос магазина с Joomla без потери управляемости и структуры</h2>
				<p>
					Перенос — это не просто копирование страниц. Важно правильно перенести каталог,
					товары, изображения, характеристики, URL-структуру, формы заказа и базовую логику,
					чтобы новый магазин на WordPress был удобен и для покупателей, и для администратора.
				</p>
			</div>

			<div class="gl-service-grid-3">
				<div class="gl-service-card">
					<h3>Анализ старого сайта</h3>
					<p>
						Проверяю текущий сайт на Joomla: структуру каталога, товары, категории, модули,
						фильтры, формы, способы оплаты, доставки и важные страницы.
					</p>
				</div>
				...
				<div class="gl-service-card">
					...
					<p>
						Переношу товары, категории, изображения, описания, цены, характеристики,
						атрибуты и другую важную информацию в WooCommerce.
					</p>
				</div>
				...
				<div class="gl-service-card">
					...
					<p>
						...
						личный кабинет и базовые страницы магазина.
					</p>
				</div>
			</div>
		</div>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Когда стоит переносить магазин с Joomla на WordPress</h2>
			</div>

			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					<ul class="gl-service-list">
						<li>Сайт на Joomla устарел, плохо обновляется или неудобен в работе</li>
						<li>Сложно менять дизайн, структуру, карточки товаров и страницы</li>
						<li>Нужно перейти на WooCommerce и развивать магазин дальше</li>
						<li>Текущий магазин работает медленно или выглядит устаревшим</li>
					</ul>
				</div>

				<div class="gl-service-card">
					<ul class="gl-service-list">
						<li>Нужна более удобная админка для управления товарами</li>
						<li>Планируются новые фильтры, оплата, доставка, CRM или API</li>
						<li>Нужно сохранить товары и контент, но обновить техническую основу</li>
						<li>Важно получить магазин, который проще дорабатывать и продвигать</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Как проходит перенос магазина с Joomla на WordPress</h2>
				<p>
					Сначала разбираю текущий сайт и данные, затем подготавливаю новую структуру на WordPress,
			...
			<div class="gl-service-steps">
				<div class="gl-service-step">
					...
					<h3>Аудит Joomla-сайта</h3>
					<p>Проверяю каталог, товары, модули, структуру страниц, ссылки, формы и важный функционал.</p>
				</div>
				...
				<div class="gl-service-step">
					...
					<p>Переношу товары, категории, изображения, описания, цены, характеристики и основной контент.</p>
				</div>

				<div class="gl-service-step">
					<div class="gl-service-step__num">04</div>
					<h3>Проверка и запуск</h3>
					<p>Тестирую каталог, карточки, корзину, checkout, адаптивность, формы и базовую логику заказа.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<p>
					...
					перенос основной структуры магазина и проверку работоспособности после миграции.
				</p>
			</div>
			...
			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					...
					<ul class="gl-service-list">
						<li>Анализ старого сайта на Joomla</li>
				...
				<div class="gl-service-card">
					...
					<ul class="gl-service-list">
						...
						<li>Проверка карточек и оформления заказа</li>
			...
			<div class="gl-service-includes-note">
				<p>
					Если на старом сайте много товаров, сложные фильтры, нестандартные модули Joomla,
					личные кабинеты, интеграции или требуется сохранение URL-структуры — это оценивается отдельно
					после анализа сайта.
				</p>
			</div>
		</div>
	...
	<section class="gl-service-section" id="service-faq">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Частые вопросы по переносу с Joomla на WordPress</h2>
			</div>

			<div class="gl-service-faq">
				<div class="gl-service-faq__item">
					<h3>Можно ли перенести товары с Joomla в WooCommerce?</h3>
					<p>
						Да. Можно перенести товары, категории, изображения, описания, цены,
						характеристики и другие данные, если они доступны в базе, выгрузке или админке сайта.
					</p>
				</div>
				...
				<div class="gl-service-faq__item">
					...
					<p>
						...
						Обычно перенос — хороший момент, чтобы обновить интерфейс и улучшить удобство покупки.
					</p>
				</div>
				...
				<div class="gl-service-faq__item">
					<h3>Сколько стоит перенос магазина с Joomla?</h3>
					<p>
						Стоимость зависит от количества товаров, структуры каталога, состояния старого сайта,
						объема контента и дополнительных функций. После анализа можно дать точную оценку.
					</p>
				</div>
			</div>
			...
			<div class="gl-service-cta">
				<div class="gl-service-cta__box">
					<h2>Хотите перенести магазин с Joomla на WordPress без хаоса и потери структуры?</h2>
					<p>
						Пришлите ссылку на текущий сайт, примерный объем товаров и список важных функций.
