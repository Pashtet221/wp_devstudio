<?php
/*
Template Name: Услуга — Перенос сайта с ModX на WordPress
		...
		<div class="gl-service-container">
			<div class="gl-service-hero__grid">
				<div class="gl-service-hero__main">
					<div class="gl-service-pill">Миграция ModX → WordPress</div>
					<h1 class="gl-service-title"><?php the_title(); ?></h1>

					<p class="gl-service-subtitle">
						Перенос сайта с ModX на WordPress с сохранением структуры,
				...
				<div class="gl-service-hero__side">
					...
					<p class="gl-service-side__text">
						...
						используемых модулей ModX, фильтров, форм, интеграций и нужных доработок.
					</p>

					<ul class="gl-service-side__list">
						<li>Перенос с ModX на WordPress</li>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Перенос сайта с ModX на WordPress без потери контента и структуры</h2>
				<p>
					Перенос с ModX — это не просто копирование страниц. Важно правильно перенести структуру,
			...
			<div class="gl-service-grid-3">
				<div class="gl-service-card">
					<h3>Аудит ModX</h3>
					<p>
						Проверяю текущий сайт на ModX: структуру сайта, страницы, разделы, шаблоны,
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Когда стоит переносить сайт с ModX на WordPress</h2>
			</div>

			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					<ul class="gl-service-list">
						<li>Текущий сайт на ModX сложно дорабатывать и развивать</li>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Как проходит перенос сайта с ModX на WordPress</h2>
				<p>
		...
		<div class="gl-service-container">
			...
			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					<h3>Перенос структуры</h3>
					<ul class="gl-service-list">
						<li>Анализ старого сайта на ModX</li>
			...
			<div class="gl-service-includes-note">
				<p>
					Если на старом сайте много страниц, сложная структура, нестандартные модули ModX,
	...
	<section class="gl-service-section" id="service-faq">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Частые вопросы по переносу с ModX на WordPress</h2>
			</div>

			<div class="gl-service-faq">
				<div class="gl-service-faq__item">
					<h3>Можно ли перенести контент из ModX в WordPress?</h3>
					<p>
				...
				<div class="gl-service-faq__item">
					...
					<p>
						...
						Часто перенос с ModX на WordPress используют как возможность обновить интерфейс,
				...
				<div class="gl-service-faq__item">
					<h3>Сколько стоит перенос сайта с ModX?</h3>
					<p>
			...
			<div class="gl-service-cta">
				<div class="gl-service-cta__box">
					<h2>Хотите перенести сайт с ModX на WordPress без потери контента и структуры?</h2>
					<p>
