<?php
/*
Template Name: Услуга — Перенос интернет-магазина с Webasyst на WooCommerce
		...
		<div class="gl-service-container">
			<div class="gl-service-hero__grid">
				<div class="gl-service-hero__main">
					<div class="gl-service-pill">Миграция Webasyst → WooCommerce</div>
					<h1 class="gl-service-title"><?php the_title(); ?></h1>

					<p class="gl-service-subtitle">
						Перенос интернет-магазина с Webasyst на WooCommerce с сохранением структуры,
				...
				<div class="gl-service-hero__side">
					...
					<p class="gl-service-side__text">
						...
						используемых модулей Webasyst, фильтров, способов оплаты, доставки и нужных доработок.
					</p>

					<ul class="gl-service-side__list">
						<li>Перенос с Webasyst на WooCommerce</li>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Перенос магазина с Webasyst на WooCommerce без потери каталога и структуры</h2>
				<p>
					Перенос с Webasyst — это не просто выгрузка товаров. Важно правильно перенести каталог,
			...
			<div class="gl-service-grid-3">
				<div class="gl-service-card">
					<h3>Аудит Webasyst</h3>
					<p>
						Проверяю текущий магазин на Webasyst: структуру каталога, товары, категории, производителей,
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Когда стоит переносить магазин с Webasyst на WooCommerce</h2>
			</div>

			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					<ul class="gl-service-list">
						<li>Текущий магазин на Webasyst сложно дорабатывать и развивать</li>
	...
	<section class="gl-service-section">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Как проходит перенос магазина с Webasyst на WooCommerce</h2>
				<p>
		...
		<div class="gl-service-container">
			...
			<div class="gl-service-grid-2">
				<div class="gl-service-card">
					...
					<ul class="gl-service-list">
						<li>Анализ старого магазина на Webasyst</li>
			...
			<div class="gl-service-includes-note">
				<p>
					Если на старом сайте много товаров, сложные фильтры, нестандартные модули Webasyst,
	...
	<section class="gl-service-section" id="service-faq">
		<div class="gl-service-container">
			<div class="gl-service-head">
				...
				<h2>Частые вопросы по переносу с Webasyst на WooCommerce</h2>
			</div>

			<div class="gl-service-faq">
				<div class="gl-service-faq__item">
					<h3>Можно ли перенести товары из Webasyst в WooCommerce?</h3>
					<p>
				...
				<div class="gl-service-faq__item">
					...
					<p>
						...
						Часто перенос с Webasyst на WooCommerce используют как возможность обновить интерфейс,
				...
				<div class="gl-service-faq__item">
					<h3>Сколько стоит перенос магазина с Webasyst?</h3>
					<p>
			...
			<div class="gl-service-cta">
				<div class="gl-service-cta__box">
					<h2>Хотите перенести магазин с Webasyst на WooCommerce без потери каталога и структуры?</h2>
					<p>
